public class Main {
        public static void main(String[] args) {
                ...
                // TESTS)
                Individu individu1 = new Individu("Nom1", "Prenom1", new DateNaissance(1, 1, 2000), "cadre",
                                new Adresse(1, "avenue de la Republique", 75000, "Paris"), "0123456789",
                                "individu@exemple.fr", "client");

                Individu individu2 = new Individu("Nom2", "Prenom2", new DateNaissance(1, 1, 1998), "cadre",
