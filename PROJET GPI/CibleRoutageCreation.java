...
public class CibleRoutageCreation extends JDialog {
    ...
    public CibleRoutageCreation(JFrame parent, String title, boolean modal, String TPub, BaseDeDonnee bd) {
    ...
    private void initComponent() {
        ...
        panTitre.setBorder(BorderFactory.createTitledBorder("Titre de la publicité "));
        ...
        panDescription.setPreferredSize(new Dimension(350, 60));
        description = new JTextField();
        description.setPreferredSize(new Dimension(190, 25));
        ...
        if (typePub == "Papier") {
            ...
            style = new JComboBox();
            style.setPreferredSize(new Dimension(100, 25));
