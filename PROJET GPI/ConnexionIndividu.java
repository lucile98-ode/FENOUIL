...
public class ConnexionIndividu extends JDialog {
    ...
    public ConnexionIndividu(JFrame parent, String title, boolean modal, Fenetre f, BaseDeDonnee bd) {
    ...
    private void initComponent() {
        ...
        panMdp.setBorder(BorderFactory.createTitledBorder("Mdp "));
        mdpLabel = new JLabel("Saisir un mdp :");
        panMdp.add(mdpLabel);
        panMdp.add(mdp);
